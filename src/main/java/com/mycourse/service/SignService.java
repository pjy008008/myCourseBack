...
import com.mycourse.security.TokenProvider;
import com.mycourse.dto.sign_in.request.SignInRequest;
import com.mycourse.dto.sign_in.response.SignInResponse;
import com.mycourse.dto.sign_up.request.SignUpRequest;
import com.mycourse.dto.sign_up.response.SignUpResponse;
...
public class SignService {
    ...
    public SignInResponse signIn(SignInRequest request) {
        ...
        return new SignInResponse(member.getPrefer(), member.getType(), token);
    }
}
